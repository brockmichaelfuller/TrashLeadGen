...
- **Who counts as a lead:** a residential curb-pickup trash hauler. The company name must either contain a hauling-related word — waste, garbage, trash, refuse, disposal, or rubbish (e.g. "Acme Waste Services", "Downtown Trash Removal") — **or** match `KNOWN_BRANDS` in `lead_scraper.py`, a curated list of major national/regional haulers (Republic Services, Waste Management, Rumpke, Recology, Burrtec, Athens Services, GFL Environmental, Casella Waste, Waste Pro, WCA Waste, Advanced Disposal, County Waste) whose local listings are often just the brand name with no generic keyword in it. "Sanitation" alone isn't a qualifying word — found live that it's just as often a portable-toilet/porta-potty rental company (e.g. "Southwest Sanitation") as a trash hauler, with nothing in the name to tell them apart. Either way, `EXCLUDE_NAME` then drops anything reading as: a utility, medical/hazardous waste, landfill/transfer station, scrap/recycling yard, government department, dumpster rental/roll-off/junk hauling, construction debris, a corporate HQ, a retail/thrift store, a moving company, a pet-waste scooper, or a tire/textile recycler. This is a name-based heuristic, not a lookup against a business registry, so it isn't perfect — review the list before outreach, and extend `KNOWN_BRANDS` or `EXCLUDE_NAME` as gaps turn up.
